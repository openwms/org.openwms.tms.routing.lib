= OpenWMS.org TMS: RESTful API (TMS Routing)
({bversion}-{bnumber})
Heiko Scherrer;
:doctype: book
:icons: font
...
[[overview]]
= Overview
This guide describes the RESTful API of the OpenWMS.org TMS Routing Service module and its usage. Some general terms and definitions are
